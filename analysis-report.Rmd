...
As we can see the expected out of sample error when using all the principal components is `r cv$error.cv[1]`.
...
Our prediction for the test set is the following:

```{r}
data.frame(problem_id=data.testing$problem_id, prediction=test.predictions)
```
